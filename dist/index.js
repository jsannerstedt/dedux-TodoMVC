...
_actions2.default.todoInput.subscribe(function (e) {
  if (e.which === ENTER_KEY) {
    var value = e.target.value && e.target.value.trim();
    if (!value) {
      return;
    }
    _actions2.default.addTodo({ title: value, completed: false, editing: false });
  }
});

_actions2.default.doneEdit.subscribe(function (payload) {
  if (!payload.todo.editing) {
    return;
  }
  if (payload.title) {
    _actions2.default.updateTodo({ todo: payload.todo, value: { editing: false, title: payload.title } });
  } else {
    _actions2.default.removeTodo(payload.todo);
  }
});

},{"../actions":4}],4:[function(require,module,exports){
'use strict';
...
var _dedux = require('dedux');

var _index = require('./modifiers/index');

var _index2 = _interopRequireDefault(_index);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = (0, _dedux.createActions)(Object.keys(_index2.default).concat(['todoInput', 'doneEdit']));

},{"./modifiers/index":6,"dedux":1}],5:[function(require,module,exports){
'use strict';
...
var store = (0, _dedux.createStore)(_modifiers2.default, _actions2.default, JSON.parse(initialState || '{}'));

if (window.location.hash) {
  _actions2.default.activateFilter(window.location.hash.slice(2));
}

var todoApp = _riot2.default.mount('todo', { state: store.getState() })[0];
...
},{"./actionHandlers":3,"./actions":4,"./modifiers":6,"./tags/todo.tag":8,"./tags/todoitem.tag":9,"dedux":1,"riot":2}],6:[function(require,module,exports){
'use strict';
...
exports.default = (0, _dedux.combineModifiers)({ todos: _todos2.default });

},{"./todos":7,"dedux":1}],7:[function(require,module,exports){
'use strict';
...
this.filters = [{ filter: 'all', label: 'All' }, { filter: 'active', label: 'Active' }, { filter: 'completed', label: 'Completed' }];

_actions2.default.addTodo.subscribe(function () {
  return _this['new-todo'].value = '';
});
this.todoInput = function (e) {
  return _actions2.default.todoInput(e);
};
this.removeCompleted = function () {
  return _actions2.default.removeCompleted();
};
this.toggleAll = function (e) {
  return _actions2.default.toggleAll(e.target.checked);
};
}, '{ }');
...
var ENTER_KEY = 13;
var ESC_KEY = 27;
var todo = this.opts.todo;

this.removeTodo = function () {
  return _actions2.default.removeTodo(todo);
};
this.toggleTodo = function () {
  return _actions2.default.updateTodo({ todo: todo, value: { completed: !todo.completed } });
};
this.doneEdit = function () {
  return _actions2.default.doneEdit({ todo: todo, title: _this.todoedit.value && _this.todoedit.value.trim() });
};
this.editTodo = function () {
  _actions2.default.updateTodo({ todo: todo, value: { editing: true } });
  _this.todoedit.value = todo.title;
  _this.todoedit.focus();
};
this.editKeyUp = function (e) {
  if (e.which === ENTER_KEY || e.which === ESC_KEY) _this.doneEdit();
};
}, '{ }');
